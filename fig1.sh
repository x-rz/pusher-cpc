...
plot "./a.txt" u 6:7 w l lt 1 lc rgb "gray", "./c.txt" u 6:7 w lp lt 6 ps 1. lc rgb "black", '-' u 1:2 w p lt 2 lc rgb "black"
0 0
e
set label 1 "(c)" at graph 0.1,0.1
