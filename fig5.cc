...
VecN u0 asm("u"),u1 asm("u1"),p asm("p"),L_U;		//4-velocity in time step n, n+1, 4-position
MatN F,FF,FFF,L_M,L_M_t;				//F: electromagnetic tensor 
static Mat3 IB_inv;
...
int main(int argc, char *argv[]){
	...
	u0=L_M_t*u0;
	U.x[0]=u0.x[0];U.x[1]=u0.x[1];U.x[2]=u0.x[2];gm=u0.x[3];				//transform 4-velocity to computational frame
#ifdef a_txt
